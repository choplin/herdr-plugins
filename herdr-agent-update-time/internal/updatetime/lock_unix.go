...
// LockError reports a failure while managing the plugin state lock.
...
// WithStateLock serializes concurrent startup and event reconciliations.
func WithStateLock(stateDir string, reconcile func() (int, error)) (int, error) {
